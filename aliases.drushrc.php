...
# 404: define my sites alias
    ...
    $aliases['debate'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'v.chinadebate.org',
    );
    $aliases['fltrp'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'new.fltrp.com',
    ...
    $aliases['ccec'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'ccec.2u4u.com.cn',
    );
    $aliases['ccec11'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'ccec11.2u4u.com.cn',
    );
    $aliases['rjb'] = array(
      'root' => '/var/www/pf7',
      'uri' => 'rijiben.org',
    ...
    $aliases['ncte'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'ncte.2u4u.com.cn',
    );
    $aliases['zuowen'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'zuowen.2u4u.com.cn',
    );
    $aliases['en'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'en.fltrp.com',
    ...
    $aliases['aca'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'academic.fltrp.com',
    );
    $aliases['ch'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'chinese.fltrp.com',
    );
    $aliases['laoge'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'laoge.fltrp.com',
    ...
    $aliases['i'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'iculture.fltrp.com',
    );
    $aliases['children'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'children.fltrp.com',
    );
    $aliases['zw09'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'zuowen09.2u4u.com.cn',
    );
    $aliases['viaton'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'viaton.fltrp.com',
    );
    $aliases['msg'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'message.fltrp.com',
    );
    $aliases['basic'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'basic.fltrp.com',
    ...
    $aliases['ru'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'ru.mlp.fltrp.com',
    );

    $aliases['ko'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'ko.mlp.fltrp.com',
    );
    $aliases['ja'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'ja.mlp.fltrp.com',
    );
    $aliases['fr'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'fr.mlp.fltrp.com',
    );
    $aliases['es'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'es.mlp.fltrp.com',
    );
    $aliases['it'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'it.mlp.fltrp.com',
    );
    $aliases['de'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'de.mlp.fltrp.com',
    );
    $aliases['ncehome'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'www.ncehome.com',
    );
    ...
    $aliases['py'] = array(
      'root' => '/var/www/pf',
      'uri' => 'pengyou.rijiben.org',
    );

    $aliases['writing'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'baoming.writing-contest.org',
    );
    $aliases['jxq'] = array(
      'root' => '/var/www/book.jiaxiaoquan.com',
      'uri' => 'book.jiaxiaoquan.com',
    );
    $aliases['bm'] = array(
      'root' => '/var/www/d7production',
      'uri' => 'bm.russian.fltrp.com',
    );
